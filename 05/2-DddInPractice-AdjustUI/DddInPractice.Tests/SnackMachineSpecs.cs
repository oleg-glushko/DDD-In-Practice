...
public class SnackMachineSpecs
{
    ...
    {
        var snackMachine = new SnackMachine(true);
        snackMachine.LoadSnacks(1, Chocolate, new SnackPile(10, 1m));
        snackMachine.InsertMoney(Dollar);
    ...
    {
        var snackMachine = new SnackMachine(true);
        snackMachine.LoadSnacks(1, Chocolate, new SnackPile(1, 2m));
        snackMachine.InsertMoney(Dollar);
    ...
    {
        var snackMachine = new SnackMachine(true);
        snackMachine.LoadSnacks(1, Chocolate, new SnackPile(1, 0.5m));
    ...
    {
        var snackMachine = new SnackMachine(true);
        snackMachine.LoadSnacks(1, Snack.Chocolate, new SnackPile(1, 0.5m));
        snackMachine.InsertMoney(Dollar);
